 ...
 */
package pw.bastiaan.github.tests.issue;
...
import pw.bastiaan.github.ui.issue.EditIssueActivity;

import org.eclipse.egit.github.core.Repository;
import org.eclipse.egit.github.core.User;

/**
 * Tests of {@link pw.bastiaan.github.ui.issue.EditIssueActivity}
 */
public class EditIssueActivityTest extends ActivityTest<EditIssueActivity> {
    ...
    public void testSaveMenuEnabled() throws Throwable {
        View saveMenu = view(pw.bastiaan.github.R.id.m_apply);
        assertFalse(saveMenu.isEnabled());
        EditText title = editText(pw.bastiaan.github.R.id.et_issue_title);
        focus(title);
        send("a");
