...
public class DiffStyler {
    ...
    public DiffStyler(final Resources resources) {
        markerColor = resources.getColor(pw.bastiaan.github.R.color.diff_marker_text);
        defaultColor = resources.getColor(pw.bastiaan.github.R.color.text);
    }
    ...
    public void updateColors(final CharSequence line, final TextView view) {
        if (TextUtils.isEmpty(line)) {
            view.setBackgroundResource(pw.bastiaan.github.R.drawable.list_item_background);
        ...
        case '@':
            view.setBackgroundResource(pw.bastiaan.github.R.drawable.diff_marker_background);
            view.setTextColor(markerColor);
            return;
        case '+':
            view.setBackgroundResource(pw.bastiaan.github.R.drawable.diff_add_background);
            view.setTextColor(defaultColor);
            return;
        case '-':
            view.setBackgroundResource(pw.bastiaan.github.R.drawable.diff_remove_background);
            view.setTextColor(defaultColor);
            return;
        default:
            view.setBackgroundResource(pw.bastiaan.github.R.drawable.list_item_background);
