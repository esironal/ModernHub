...
import static pw.bastiaan.github.Intents.EXTRA_GIST_FILE;
...
public class GistFileFragment extends DialogFragment implements
    ...
    public void onCreateOptionsMenu(Menu optionsMenu, MenuInflater inflater) {
        inflater.inflate(pw.bastiaan.github.R.menu.code_view, optionsMenu);

        wrapItem = optionsMenu.findItem(pw.bastiaan.github.R.id.m_wrap);
        updateWrapItem();
    }

    private void updateWrapItem() {
        if (wrapItem != null)
            if (codePrefs.getBoolean(PreferenceUtils.WRAP, false))
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case pw.bastiaan.github.R.id.m_wrap:
            ...
            PreferenceUtils.save(codePrefs.edit().putBoolean(PreferenceUtils.WRAP,
                    editor.getWrap()));
            return true;
        default:
    ...
    private void loadSource() {
        new AuthenticatedUserTask<GistFile>(getActivity()) {
            ...
            protected void onException(Exception e) throws RuntimeException {
                ...
                ToastUtils.show(getActivity(), e, pw.bastiaan.github.R.string.error_gist_file_load);
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(pw.bastiaan.github.R.layout.gist_file_view, null);
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
            String key) {
        if (PreferenceUtils.WRAP.equals(key)) {
            updateWrapItem();
            editor.setWrap(sharedPreferences.getBoolean(PreferenceUtils.WRAP, false));
        }
    }
}
