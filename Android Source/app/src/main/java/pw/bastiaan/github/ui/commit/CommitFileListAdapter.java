...
import pw.bastiaan.github.core.commit.FullCommitFile;
...
public class CommitFileListAdapter extends MultiTypeAdapter {
    ...
    public CommitFileListAdapter(final LayoutInflater inflater,
        ...
        addTextColor = resources.getColor(pw.bastiaan.github.R.color.diff_add_text);
        removeTextColor = resources.getColor(pw.bastiaan.github.R.color.diff_remove_text);
    }
    ...
    protected int getChildLayoutId(final int type) {
        switch (type) {
        case TYPE_FILE_HEADER:
            return pw.bastiaan.github.R.layout.commit_diff_file_header;
        case TYPE_FILE_LINE:
            return pw.bastiaan.github.R.layout.commit_diff_line;
        case TYPE_LINE_COMMENT:
            return pw.bastiaan.github.R.layout.diff_comment_item;
        case TYPE_COMMENT:
            return pw.bastiaan.github.R.layout.commit_comment_item;
        default:
            return -1;
        }
    }
    ...
    protected int[] getChildViewIds(final int type) {
        switch (type) {
        case TYPE_FILE_HEADER:
            return new int[] { pw.bastiaan.github.R.id.tv_name, pw.bastiaan.github.R.id.tv_folder, pw.bastiaan.github.R.id.tv_stats };
        case TYPE_FILE_LINE:
            return new int[] { pw.bastiaan.github.R.id.tv_diff };
        case TYPE_LINE_COMMENT:
        case TYPE_COMMENT:
            return new int[] { pw.bastiaan.github.R.id.tv_comment_body, pw.bastiaan.github.R.id.iv_avatar,
                    pw.bastiaan.github.R.id.tv_comment_author, pw.bastiaan.github.R.id.tv_comment_date };
        default:
            return null;
        }
    }
