...
import pw.bastiaan.github.ui.FragmentPagerAdapter;
import pw.bastiaan.github.ui.repo.RepositoryListFragment;
...
public class HomePagerAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            case 0:
                return resources.getString(pw.bastiaan.github.R.string.tab_news);
            case 1:
                return resources.getString(pw.bastiaan.github.R.string.tab_repositories);
            case 2:
                return resources.getString(defaultUser ? pw.bastiaan.github.R.string.tab_followers_self
                    : pw.bastiaan.github.R.string.tab_members);
            case 3:
                return resources.getString(pw.bastiaan.github.R.string.tab_following_self);
            default:
                return null;
        }
    }
