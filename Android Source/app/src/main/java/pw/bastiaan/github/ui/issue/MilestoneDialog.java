...
public class MilestoneDialog {
    ...
    private void load(final Milestone selectedMilestone) {
        new ProgressDialogTask<ArrayList<Milestone>>(activity) {
            ...
            protected void onException(Exception e) throws RuntimeException {
                ...
                ToastUtils.show(activity, e, pw.bastiaan.github.R.string.error_milestones_load);
            }

            @Override
            public void execute() {
                showIndeterminate(pw.bastiaan.github.R.string.loading_milestones);
    ...
    public void show(Milestone selectedMilestone) {
        ...
        MilestoneDialogFragment.show(activity, requestCode,
                activity.getString(pw.bastiaan.github.R.string.select_milestone), null,
