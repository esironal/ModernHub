...
import pw.bastiaan.github.ui.FragmentStatePagerAdapter;
...
public class IssueDashboardPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(final int position) {
        ...
        bundle.putSerializable(DashboardIssueFragment.ARG_FILTER, (Serializable) filterData);
    ...
    public CharSequence getPageTitle(final int position) {
        switch (position) {
            case 0:
                return resources.getString(pw.bastiaan.github.R.string.tab_watched);
            case 1:
                return resources.getString(pw.bastiaan.github.R.string.tab_assigned);
            case 2:
                return resources.getString(pw.bastiaan.github.R.string.tab_created);
            case 3:
                return resources.getString(pw.bastiaan.github.R.string.tab_mentioned);
            default:
                return null;
        }
    }
