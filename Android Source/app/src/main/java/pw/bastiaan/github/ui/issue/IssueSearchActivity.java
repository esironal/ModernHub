...
public class IssueSearchActivity extends RoboActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu options) {
        getMenuInflater().inflate(pw.bastiaan.github.R.menu.search, options);

        SearchManager searchManager = (SearchManager) getSystemService(Context.SEARCH_SERVICE);
        MenuItem searchItem = options.findItem(pw.bastiaan.github.R.id.m_search);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case pw.bastiaan.github.R.id.m_clear:
                IssueSearchSuggestionsProvider.clear(this);
                ToastUtils.show(this, pw.bastiaan.github.R.string.search_history_cleared);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(pw.bastiaan.github.R.layout.issue_search);
