package pw.bastiaan.github.core.repo;
...
import pw.bastiaan.github.accounts.AccountAuthenticator;
import pw.bastiaan.github.api.GitHubClientV2;
import pw.bastiaan.github.model.Authorization;
...
public class DeleteRepositoryTask extends ProgressDialogTask<Void> {
     ...
     */
    public void start() {
        showIndeterminate(pw.bastiaan.github.R.string.deleting_repository);
