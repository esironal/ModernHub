...
import pw.bastiaan.github.ui.DialogFragmentHelper;
...
public class LabelsDialogFragment extends DialogFragmentHelper implements
    ...
    private static class LabelListAdapter extends SingleTypeAdapter<Label>
        ...
        public LabelListAdapter(LayoutInflater inflater, Label[] labels,
                boolean[] selected) {
            super(inflater, pw.bastiaan.github.R.layout.label_item);
        ...
        protected int[] getChildViewIds() {
            return new int[] { pw.bastiaan.github.R.id.tv_label_name, pw.bastiaan.github.R.id.cb_selected };
        }
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        ListView view = (ListView) inflater.inflate(pw.bastiaan.github.R.layout.dialog_list_view,
                null);
        ...
        dialog.setButton(BUTTON_NEGATIVE, activity.getString(pw.bastiaan.github.R.string.cancel),
                this);
        dialog.setButton(BUTTON_NEUTRAL, activity.getString(pw.bastiaan.github.R.string.clear), this);
        dialog.setButton(BUTTON_POSITIVE, activity.getString(pw.bastiaan.github.R.string.apply),
                this);
