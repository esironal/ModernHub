...
public class RepositoryIssueListAdapter extends IssueListAdapter<Issue> {
    ...
    protected int[] getChildViewIds() {
        return new int[] { pw.bastiaan.github.R.id.tv_issue_number, pw.bastiaan.github.R.id.tv_issue_title, pw.bastiaan
                .github.R.id.iv_avatar,
                pw.bastiaan.github.R.id.tv_issue_creation, pw.bastiaan.github.R.id.tv_issue_comments,
                pw.bastiaan.github.R.id.tv_pull_request_icon, pw.bastiaan.github.R.id.v_label0, pw.bastiaan.github.R.id
                .v_label1, pw.bastiaan.github.R.id.v_label2,
                pw.bastiaan.github.R.id.v_label3, pw.bastiaan.github.R.id.v_label4, pw.bastiaan.github.R.id.v_label5, pw
                .bastiaan.github.R.id.v_label6, pw.bastiaan.github.R.id.v_label7 };
    }
