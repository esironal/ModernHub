...
import pw.bastiaan.github.core.commit.CommitMatch;
import pw.bastiaan.github.core.commit.CommitUriMatcher;
import pw.bastiaan.github.core.gist.GistUriMatcher;
import pw.bastiaan.github.core.issue.IssueUriMatcher;
import pw.bastiaan.github.core.repo.RepositoryUriMatcher;
import pw.bastiaan.github.core.user.UserUriMatcher;
...
public class UriLauncherActivity extends Activity {
    ...
    private void showParseError(String url) {
        ...
        dialog.setTitle(pw.bastiaan.github.R.string.title_invalid_github_url);
        dialog.setMessage(MessageFormat.format(getString(pw.bastiaan.github.R.string.message_invalid_github_url), url));
