...
public abstract class TabPagerActivity<V extends PagerAdapter & FragmentProvider>
    ...
    protected int getContentView() {
        return pw.bastiaan.github.R.layout.pager_with_tabs;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pager = (ViewPager) findViewById(pw.bastiaan.github.R.id.vp_pages);
        pager.setOnPageChangeListener(this);
        slidingTabsLayout = (SlidingTabLayout) findViewById(pw.bastiaan.github.R.id.sliding_tabs_layout);
        slidingTabsLayout.setCustomTabView(pw.bastiaan.github.R.layout.tab, pw.bastiaan.github.R.id.tv_tab);
