...
import static pw.bastiaan.github.util.TypefaceUtils.ICON_CODE;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_COMMIT;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_ISSUE_OPEN;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_NEWS;
...
import pw.bastiaan.github.core.repo.DeleteRepositoryTask;
import pw.bastiaan.github.core.repo.ForkRepositoryTask;
import pw.bastiaan.github.core.repo.RefreshRepositoryTask;
import pw.bastiaan.github.core.repo.RepositoryUtils;
import pw.bastiaan.github.core.repo.StarRepositoryTask;
import pw.bastiaan.github.core.repo.StarredRepositoryTask;
import pw.bastiaan.github.core.repo.UnstarRepositoryTask;
import pw.bastiaan.github.ui.TabPagerActivity;
import pw.bastiaan.github.ui.user.UriLauncherActivity;
...
public class RepositoryViewActivity extends TabPagerActivity<RepositoryPagerAdapter> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingBar = finder.find(pw.bastiaan.github.R.id.progress_bar);
        ...
        if (owner.getAvatarUrl() != null && RepositoryUtils.isComplete(repository))
            ...
            new RefreshRepositoryTask(this, repository) {
                ...
                protected void onException(Exception e) throws RuntimeException {
                    ...
                    ToastUtils.show(RepositoryViewActivity.this, pw.bastiaan.github.R.string.error_repo_load);
    ...
    public boolean onCreateOptionsMenu(Menu optionsMenu) {
        getMenuInflater().inflate(pw.bastiaan.github.R.menu.repository, optionsMenu);
        return super.onCreateOptionsMenu(optionsMenu);
    }

    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {
        MenuItem followItem = menu.findItem(pw.bastiaan.github.R.id.m_star);

        followItem.setVisible(starredStatusChecked);
        followItem.setTitle(isStarred ? pw.bastiaan.github.R.string.unstar : pw.bastiaan.github.R.string.star);
    ...
    public void onBackPressed() {
        if (adapter == null || pager.getCurrentItem() != RepositoryPagerAdapter.ITEM_CODE || !adapter.onBackPressed())
            super.onBackPressed();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case pw.bastiaan.github.R.id.m_star:
                starRepository();
                return true;
            case pw.bastiaan.github.R.id.m_fork:
                forkRepository();
                return true;
            case pw.bastiaan.github.R.id.m_contributors:
                startActivity(RepositoryContributorsActivity.createIntent(repository));
                return true;
            case pw.bastiaan.github.R.id.m_share:
                shareRepository();
                return true;
            case pw.bastiaan.github.R.id.m_delete:
                deleteRepository();
                return true;
    ...
    protected int getContentView() {
        return pw.bastiaan.github.R.layout.tabbed_progress_pager;
    }
        ...
        if (isStarred)
            new UnstarRepositoryTask(this, repository) {
                ...
                protected void onException(Exception e) throws RuntimeException {
                    ...
                    ToastUtils.show(RepositoryViewActivity.this, pw.bastiaan.github.R.string.error_unstarring_repository);
                }
            }.start();
        else
            new StarRepositoryTask(this, repository) {
                ...
                protected void onException(Exception e) throws RuntimeException {
                    ...
                    ToastUtils.show(RepositoryViewActivity.this, pw.bastiaan.github.R.string.error_starring_repository);
                }
            }.start();
    }
        ...
        new ForkRepositoryTask(this, repository) {
            ...
            protected void onSuccess(Repository e) throws Exception {
                ...
                if (e != null) {
                    ...
                    ToastUtils.show(RepositoryViewActivity.this, pw.bastiaan.github.R.string.error_forking_repository);
                }
            }
    ...
    private void deleteRepository() {
        new MaterialDialog.Builder(this)
                .title(pw.bastiaan.github.R.string.are_you_sure)
                .content(pw.bastiaan.github.R.string.unexpected_bad_things)
                .positiveText(pw.bastiaan.github.R.string.not_sure)
                .negativeText(pw.bastiaan.github.R.string.delete_cap)
                    ...
                    public void onNegative(MaterialDialog dialog) {
                        ...
                        new DeleteRepositoryTask(RepositoryViewActivity.this, repository) {
                            ...
                            protected void onSuccess(Void v) throws Exception {
                                super.onSuccess(v);
                                onBackPressed();
                                ToastUtils.show(RepositoryViewActivity.this, pw.bastiaan.github.R.string.delete_successful);
                            }
                            ...
                            protected void onException(Exception e) throws RuntimeException {
                                ...
                                ToastUtils.show(RepositoryViewActivity.this, pw.bastiaan.github.R.string.error_deleting_repository);
                            }
                        }.start();
                    }
                })
