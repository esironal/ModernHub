...
public class ResourceLoadingIndicator {
    ...
    public ResourceLoadingIndicator(final Context context,
        ...
        view = LayoutInflater.from(context).inflate(pw.bastiaan.github.R.layout.loading_item, null);
        textView = (TextView) view.findViewById(pw.bastiaan.github.R.id.tv_loading);
