...
public class SearchUserListAdapter extends SingleTypeAdapter<SearchUser> {
    ...
    public SearchUserListAdapter(final Context context,
        ...
        super(LayoutInflater.from(context), pw.bastiaan.github.R.layout.user_item);
    ...
    protected int[] getChildViewIds() {
        return new int[] { pw.bastiaan.github.R.id.iv_avatar, pw.bastiaan.github.R.id.tv_login };
    }
