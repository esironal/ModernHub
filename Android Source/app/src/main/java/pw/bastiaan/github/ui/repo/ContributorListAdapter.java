...
public class ContributorListAdapter extends SingleTypeAdapter<Contributor> {
    ...
    public ContributorListAdapter(final Context context,
        ...
        super(LayoutInflater.from(context), pw.bastiaan.github.R.layout.contributor_item);
    ...
    protected int[] getChildViewIds() {
        return new int[] { pw.bastiaan.github.R.id.iv_avatar, pw.bastiaan.github.R.id.tv_login, pw.bastiaan.github.R.id.tv_contributions };
    }
    ...
    protected void update(int position, Contributor contributor) {
        ...
        setText(2, context.getString(pw.bastiaan.github.R.string.contributions, contributor.getContributions()));
    }
}
