...
import pw.bastiaan.github.ui.roboactivities.RoboActionBarActivity;
...
public class TwoFactorAuthActivity extends RoboActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(pw.bastiaan.github.R.layout.login_two_factor_auth);
        ...
        otpCodeText = finder.find(pw.bastiaan.github.R.id.et_otp_code);
        ...
        signupText.setText(Html.fromHtml(getString(pw.bastiaan.github.R.string.signup_link_two_factor_auth)));
    ...
    public boolean onCreateOptionsMenu(Menu optionsMenu) {
        getMenuInflater().inflate(pw.bastiaan.github.R.menu.login, optionsMenu);
        loginItem = optionsMenu.findItem(pw.bastiaan.github.R.id.m_login);
        return true;
    }
    ...
    private void handleLogin() {
        ...
        authenticationTask = new RoboAsyncTask<User>(this) {
            ...
            public User call() throws Exception {
                ...
                accountManager.setAuthToken(account, AccountConstants.ACCOUNT_TYPE, authToken);
