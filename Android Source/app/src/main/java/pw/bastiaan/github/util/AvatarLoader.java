 ...
 */
package pw.bastiaan.github.util;
...
import pw.bastiaan.github.core.search.SearchUser;
...
public class AvatarLoader {
    ...
    public AvatarLoader(final Context context) {
        ...
        loadingAvatar = context.getResources().getDrawable(
                pw.bastiaan.github.R.drawable.gravatar_icon);
    ...
    private int getMaxAvatarSize(final Context context) {
        ...
        TypedArray array = context.obtainStyledAttributes(pw.bastiaan.github.R.style.AvatarXLarge, attrs);
    ...
    private AvatarLoader setImage(final Drawable image, final ImageView view,
        ...
        view.setTag(pw.bastiaan.github.R.id.iv_avatar, tag);
    ...
    private FetchAvatarTask fetchAvatarTask(final String avatarUrl,
        ...
        return new FetchAvatarTask(context) {
            ...
            @Override
            public BitmapDrawable call() throws Exception {
                if (!userId.equals(view.getTag(pw.bastiaan.github.R.id.iv_avatar)))
                    return null;
