...
public class MembersFragment extends ItemListFragment<User> {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (org != null)
            outState.putSerializable(Intents.EXTRA_USER, org);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (org == null && savedInstanceState != null)
            org = (User) savedInstanceState.getSerializable(Intents.EXTRA_USER);
        setEmptyText(pw.bastiaan.github.R.string.no_members);
    ...
    protected int getErrorMessage(Exception exception) {
        return pw.bastiaan.github.R.string.error_members_load;
    }
}
