...
/**
 * Adapter to display a list of {@link pw.bastiaan.github.core.issue.IssueFilter} objects
 */
public class FilterListAdapter extends SingleTypeAdapter<IssueFilter> {
    ...
    public FilterListAdapter(LayoutInflater inflater, IssueFilter[] elements,
        ...
        super(inflater, pw.bastiaan.github.R.layout.issues_filter_item);
    ...
    protected int[] getChildViewIds() {
        return new int[] { pw.bastiaan.github.R.id.iv_avatar, pw.bastiaan.github.R.id.tv_repo_name, pw.bastiaan.github.R.id.tv_filter_state,
                pw.bastiaan.github.R.id.tv_filter_labels, pw.bastiaan.github.R.id.tv_filter_milestone, pw.bastiaan.github.R.id.ll_assignee,
                pw.bastiaan.github.R.id.tv_filter_assignee, pw.bastiaan.github.R.id.iv_assignee_avatar };
    }
    ...
    protected void update(int position, IssueFilter filter) {
        ...
        if (filter.isOpen())
            setText(2, pw.bastiaan.github.R.string.open_issues);
        else
            setText(2, pw.bastiaan.github.R.string.closed_issues);
