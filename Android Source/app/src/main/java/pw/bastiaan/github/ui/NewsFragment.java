...
import pw.bastiaan.github.core.gist.GistEventMatcher;
import pw.bastiaan.github.core.issue.IssueEventMatcher;
import pw.bastiaan.github.core.repo.RepositoryEventMatcher;
import pw.bastiaan.github.core.user.UserEventMatcher;
import pw.bastiaan.github.ui.commit.CommitCompareViewActivity;
import pw.bastiaan.github.ui.commit.CommitViewActivity;
import pw.bastiaan.github.ui.gist.GistsViewActivity;
import pw.bastiaan.github.ui.issue.IssuesViewActivity;
import pw.bastiaan.github.ui.repo.RepositoryViewActivity;
import pw.bastiaan.github.ui.user.NewsListAdapter;
...
public abstract class NewsFragment extends PagedItemFragment<Event> {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        setEmptyText(pw.bastiaan.github.R.string.no_news);
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        UserEventMatcher.UserPair users = userMatcher.getUsers(event);
        if (users != null)
            viewUser(users);
    }
    ...
    public boolean onListItemLongClick(ListView l, View v, int position,
        ...
        if (repo != null && user != null) {
            ...
            dialog.setTitle(pw.bastiaan.github.R.string.navigate_to);
            dialog.setCanceledOnTouchOutside(true);

            View view = getActivity().getLayoutInflater().inflate(
                    pw.bastiaan.github.R.layout.nav_dialog, null);
            ViewFinder finder = new ViewFinder(view);
            avatars.bind(finder.imageView(pw.bastiaan.github.R.id.iv_user_avatar), user);
            avatars.bind(finder.imageView(pw.bastiaan.github.R.id.iv_repo_avatar), repo.getOwner());
            finder.setText(pw.bastiaan.github.R.id.tv_login, user.getLogin());
            finder.setText(pw.bastiaan.github.R.id.tv_repo_name, repo.generateId());
            finder.onClick(pw.bastiaan.github.R.id.ll_user_area, new OnClickListener() {
            ...
            finder.onClick(pw.bastiaan.github.R.id.ll_repo_area, new OnClickListener() {
    ...
    /**
     * Start an activity to view the given {@link pw.bastiaan.github.core.user.UserEventMatcher.UserPair}
     * <p>
    ...
    protected int getLoadingMessage() {
        return pw.bastiaan.github.R.string.loading_news;
    }

    @Override
    protected int getErrorMessage(Exception exception) {
        return pw.bastiaan.github.R.string.error_news_load;
    }
}
