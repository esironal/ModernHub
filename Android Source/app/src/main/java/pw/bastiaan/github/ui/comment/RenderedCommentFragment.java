...
public class RenderedCommentFragment extends DialogFragment implements
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        bodyText = finder.find(pw.bastiaan.github.R.id.tv_comment_body);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(pw.bastiaan.github.R.layout.comment_preview, null);
    }
    ...
    public void onLoadFinished(Loader<CharSequence> loader,
        ...
        if (rendered == null)
            ToastUtils.show(getActivity(), pw.bastiaan.github.R.string.error_rendering_markdown);
