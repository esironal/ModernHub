...
import static pw.bastiaan.github.util.TypefaceUtils.ICON_ADD_MEMBER;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_COMMENT;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_CREATE;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_DELETE;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_FOLLOW;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_FORK;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_GIST;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_ISSUE_CLOSE;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_ISSUE_COMMENT;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_ISSUE_OPEN;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_ISSUE_REOPEN;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_PULL_REQUEST;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_PUSH;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_STAR;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_UPLOAD;
import static pw.bastiaan.github.util.TypefaceUtils.ICON_WIKI;
...
import pw.bastiaan.github.util.TimeUtils;
...
public class NewsListAdapter extends SingleTypeAdapter<Event> {
    ...
    public NewsListAdapter(LayoutInflater inflater, Event[] elements,
        ...
        super(inflater, pw.bastiaan.github.R.layout.news_item);
    ...
    protected int[] getChildViewIds() {
        return new int[] { pw.bastiaan.github.R.id.iv_avatar, pw.bastiaan.github.R.id.tv_event, pw.bastiaan.github.R.id.tv_event_details,
                pw.bastiaan.github.R.id.tv_event_icon, pw.bastiaan.github.R.id.tv_event_date };
    }
