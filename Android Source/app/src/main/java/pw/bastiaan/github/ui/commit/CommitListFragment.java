...
import pw.bastiaan.github.core.commit.CommitPager;
import pw.bastiaan.github.core.commit.CommitStore;
import pw.bastiaan.github.core.ref.RefUtils;
import pw.bastiaan.github.ui.DialogFragmentActivity;
import pw.bastiaan.github.ui.DialogResultListener;
...
public class CommitListFragment extends PagedItemFragment<RepositoryCommit>
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        setEmptyText(pw.bastiaan.github.R.string.no_commits);
    }
    ...
    protected int getLoadingMessage() {
        return pw.bastiaan.github.R.string.loading_commits;
    }

    @Override
    protected int getErrorMessage(Exception exception) {
        return pw.bastiaan.github.R.string.error_commits_load;
    }

    @Override
    protected SingleTypeAdapter<RepositoryCommit> createAdapter(
            List<RepositoryCommit> items) {
        return new CommitListAdapter(pw.bastiaan.github.R.layout.commit_item, getActivity()
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (item instanceof RepositoryCommit)
            startActivityForResult(CommitViewActivity.createIntent(repository,
                    position, items), RequestCodes.COMMIT_VIEW);
    }

    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RequestCodes.COMMIT_VIEW) {
    ...
    private void switchRefs() {
        ...
        if (dialog == null)
            dialog = new RefDialog((DialogFragmentActivity) getActivity(),
                    RequestCodes.REF_UPDATE, repository, dataService);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(pw.bastiaan.github.R.layout.commit_list, null);
    }
}
