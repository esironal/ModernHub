...
import pw.bastiaan.github.ui.SingleChoiceDialogFragment;
...
public class RefDialogFragment extends SingleChoiceDialogFragment {
    ...
    private static class RefListAdapter extends SingleTypeAdapter<Reference> {
        ...
        public RefListAdapter(LayoutInflater inflater, Reference[] refs,
                int selected) {
            super(inflater, pw.bastiaan.github.R.layout.ref_item);
        ...
        protected int[] getChildViewIds() {
            return new int[] { pw.bastiaan.github.R.id.tv_ref_icon, pw.bastiaan.github.R.id.tv_ref, pw.bastiaan.github.R.id.rb_selected };
        }
        ...
        protected void update(int position, Reference item) {
            if (RefUtils.isTag(item))
                setText(0, pw.bastiaan.github.R.string.icon_tag);
            else
                setText(0, pw.bastiaan.github.R.string.icon_fork);
