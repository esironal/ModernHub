 ...
 */
package pw.bastiaan.github.accounts;
...
import static pw.bastiaan.github.RequestCodes.OTP_CODE_ENTER;
import static pw.bastiaan.github.accounts.TwoFactorAuthActivity.PARAM_EXCEPTION;
...
import pw.bastiaan.github.ui.LightProgressDialog;
import pw.bastiaan.github.ui.TextWatcherAdapter;
import pw.bastiaan.github.ui.roboactivities.RoboActionBarAccountAuthenticatorActivity;
...
public class LoginActivity extends RoboActionBarAccountAuthenticatorActivity {
    ...
    public static void configureSyncFor(Account account) {
        ...
        ContentResolver.addPeriodicSync(account, AccountConstants.PROVIDER_AUTHORITY,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(pw.bastiaan.github.R.layout.login);
        ...
        loginText = finder.find(pw.bastiaan.github.R.id.et_login);
        passwordText = finder.find(pw.bastiaan.github.R.id.et_password);
        ...
        TextView signupText = finder.find(pw.bastiaan.github.R.id.tv_signup);
        signupText.setMovementMethod(LinkMovementMethod.getInstance());
        signupText.setText(Html.fromHtml(getString(pw.bastiaan.github.R.string.signup_link)));
        ...
        CheckBox showPassword = finder.find(pw.bastiaan.github.R.id.cb_show_password);
    ...
    public void handleLogin() {
        ...
        final AlertDialog dialog = LightProgressDialog.create(this,
            pw.bastiaan.github.R.string.login_activity_authenticating);
    ...
    protected void finishLogin(final String username, final String password) {
        ...
        intent.putExtra(KEY_ACCOUNT_TYPE, AccountConstants.ACCOUNT_TYPE);
    ...
    public void onAuthenticationResult(boolean result) {
        if (result) {
            ...
            if (requestNewAccount)
                ToastUtils.show(this, pw.bastiaan.github.R.string.invalid_login_or_password);
            else
                ToastUtils.show(this, pw.bastiaan.github.R.string.invalid_password);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case pw.bastiaan.github.R.id.m_login:
                handleLogin();
                return true;
            default:
    ...
    public boolean onCreateOptionsMenu(Menu optionMenu) {
        getMenuInflater().inflate(pw.bastiaan.github.R.menu.login, optionMenu);
        loginItem = optionMenu.findItem(pw.bastiaan.github.R.id.m_login);
        return true;
    }
    ...
    private void handleLoginException(final Exception e) {
        if (AccountUtils.isUnauthorized(e))
            ...
            ToastUtils.show(LoginActivity.this, e, pw.bastiaan.github.R.string.code_authentication_failed);
    }
}
