...
public class AssigneeDialog {
    ...
    private void load(final User selectedAssignee) {
        new ProgressDialogTask<List<User>>(activity) {
            ...
            protected void onException(Exception e) throws RuntimeException {
                ...
                ToastUtils.show(activity, e, pw.bastiaan.github.R.string.error_collaborators_load);
            }

            @Override
            public void execute() {
                showIndeterminate(pw.bastiaan.github.R.string.loading_collaborators);
    ...
    public void show(User selectedAssignee) {
        ...
        AssigneeDialogFragment.show(activity, requestCode,
                activity.getString(pw.bastiaan.github.R.string.select_assignee), null, users,
                checked);
    }
}
