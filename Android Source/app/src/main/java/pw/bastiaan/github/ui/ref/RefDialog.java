...
public class RefDialog {
    ...
    private void load(final Reference selectedRef) {
        new ProgressDialogTask<List<Reference>>(activity) {
            ...
            protected void onException(Exception e) throws RuntimeException {
                ...
                ToastUtils.show(activity, e, pw.bastiaan.github.R.string.error_refs_load);
            }

            @Override
            public void execute() {
                showIndeterminate(pw.bastiaan.github.R.string.loading_refs);
    ...
    public void show(Reference selectedRef) {
        ...
        RefDialogFragment.show(activity, requestCode,
                activity.getString(pw.bastiaan.github.R.string.select_ref), null, refList, checked);
    }
}
