...
import static pw.bastiaan.github.Intents.EXTRA_ISSUE_FILTER;
import static pw.bastiaan.github.Intents.EXTRA_REPOSITORY;
import static pw.bastiaan.github.RequestCodes.ISSUE_CREATE;
import static pw.bastiaan.github.RequestCodes.ISSUE_FILTER_EDIT;
import static pw.bastiaan.github.RequestCodes.ISSUE_VIEW;
...
public class IssuesFragment extends PagedItemFragment<Issue> {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        filterHeader = getLayoutInflater(savedInstanceState).inflate(
                pw.bastiaan.github.R.layout.issues_filter_header, null);
        state = (TextView) filterHeader.findViewById(pw.bastiaan.github.R.id.tv_filter_state);
        labels = (TextView) filterHeader.findViewById(pw.bastiaan.github.R.id.tv_filter_labels);
        milestone = (TextView) filterHeader
                .findViewById(pw.bastiaan.github.R.id.tv_filter_milestone);
        assigneeArea = filterHeader.findViewById(pw.bastiaan.github.R.id.ll_assignee);
        assignee = (TextView) filterHeader.findViewById(pw.bastiaan.github.R.id.tv_filter_assignee);
    ...
    private void updateFilterSummary() {
        if (filter.isOpen())
            state.setText(pw.bastiaan.github.R.string.open_issues);
        else
            state.setText(pw.bastiaan.github.R.string.closed_issues);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        setEmptyText(pw.bastiaan.github.R.string.no_issues);
    }
    ...
    public void onCreateOptionsMenu(Menu optionsMenu, MenuInflater inflater) {
        inflater.inflate(pw.bastiaan.github.R.menu.issues, optionsMenu);

        SearchManager searchManager = (SearchManager) getActivity().getSystemService(Context.SEARCH_SERVICE);
        MenuItem searchItem = optionsMenu.findItem(pw.bastiaan.github.R.id.m_search);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case pw.bastiaan.github.R.id.create_issue:
            startActivityForResult(EditIssueActivity.createIntent(repository),
                    ISSUE_CREATE);
            return true;
        case pw.bastiaan.github.R.id.m_filter:
            startActivityForResult(
                    EditIssuesFilterActivity.createIntent(filter),
                    ISSUE_FILTER_EDIT);
            return true;
        case pw.bastiaan.github.R.id.m_bookmark:
            cache.addIssueFilter(filter, new RequestFuture<IssueFilter>() {

                public void success(IssueFilter response) {
                    ToastUtils.show(getActivity(), pw.bastiaan.github.R.string.message_filter_saved);
                }
            });
            return true;
        default:
